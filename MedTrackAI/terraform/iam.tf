...
resource "aws_iam_role" "eks_cluster_role" {
  name = "medtracker-eks-cluster-role"
...
# Application IAM Role for Secrets Manager
resource "aws_iam_role" "app_role" {
  name = "medtracker-app-role"
...
resource "aws_iam_policy" "app_secrets_policy" {
  name        = "medtracker-app-secrets-policy"
